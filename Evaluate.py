...
def Evaluate(jsonpath, ResultAudioPath, gtAudioPath):
    ...
    for keys in gt:
        ...
        # l1 = len(read_signal(os.path.join(ResultAudioPath, file_prefix + '__seg1.wav')))
        # if l < l1:
        #     l1 = l
        l1=l
        ...
        ori_est_sources[0, :] = read_signal(os.path.join(ResultAudioPath, file_prefix + '__seg1.wav'))[:l1]
        ori_est_sources[1, :] = read_signal(os.path.join(ResultAudioPath, file_prefix + '__seg2.wav'))[:l1]
        MaxL = 2000000
